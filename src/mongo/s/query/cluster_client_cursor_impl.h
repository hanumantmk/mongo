...
public:
     ...
     * Constructs a CCC whose safe cleanup is ensured by an RAII object.
     */
    static ClusterClientCursorGuard make(std::unique_ptr<executor::TaskExecutor> executor,
                                         ClusterClientCursorParams&& params);
...
private:
    ...
    ClusterClientCursorImpl(std::unique_ptr<executor::TaskExecutor> executor, ClusterClientCursorParams&& params);
