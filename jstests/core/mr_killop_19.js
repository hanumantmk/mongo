...
t = db.jstests_mr_killop_19;
t.drop();
t2 = db.jstests_mr_killop_19_out;
t2.drop();
    ...
    for (var i in p) {
        ...
        if (childLoop) {
            if ((o.active || o.waitingForLock) && o.query && o.query.query &&
                o.query.query.$where && o.query.distinct == "jstests_mr_killop_19") {
                return o.opid;
            }
        } else {
            if ((o.active || o.waitingForLock) && o.query && o.query.mapreduce &&
                o.query.mapreduce == "jstests_mr_killop_19") {
                return o.opid;
            }
        }
    }
...
function testOne(map, reduce, finalize, scope, childLoop, wait) {
    ...
    spec = {mapreduce: "jstests_mr_killop_19", out: "jstests_mr_killop_19_out", map: map, reduce: reduce};
    if (finalize) {
